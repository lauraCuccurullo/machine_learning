...
elseif (strcmp(tree.value, 'false'))
    ...
    fprintf('parent: %s\tattribute: %s\tleftChild:%s\tleftcenterChild:%s\trightcenterChild:%s\trightChild:%s\n', ...
        parent, tree.value, tree.left.value, tree.leftcenter.value, tree.rightcenter.value, tree.right.value);
end
...
PrintTree(tree.leftcenter, tree.value);

% Chiamata ricorsiva di centro
PrintTree(tree.rightcenter, tree.value);
